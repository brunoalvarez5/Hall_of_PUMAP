...
#load ONNX model
onnx_model_path = "./Mark_VII_model.onnx"  # Change this to your actual ONNX file
session = ort.InferenceSession(onnx_model_path)

#load datasets
cortex_data = np.load("./embeddings_from_curated_braingeners_to_test_model.npy").astype(np.float32)
...
with open("./testing_set_encodings_embeddings.csv", "w", newline="") as f:    
    writer = csv.writer(f)
