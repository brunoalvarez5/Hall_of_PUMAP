...
train_embeddings['Label'] = train_embeddings['Label'].astype('str')
train_embeddings['Predictions'] = train_embeddings['Predictions'].astype('str')

#we create the plot

#we plot for labels
plt.figure(figsize=(8,6))
sns.scatterplot(x='Dim1', y='Dim2', hue='Label', palette='tab20', data=train_embeddings, s=10)
...
plt.figure(figsize=(8,6))
sns.scatterplot(x='Dim1', y='Dim2', hue='Predictions', palette='tab20', data=train_embeddings, s=10)
...
#PUMAP_clustering_with_labels.png
#PUMAP_clustering_with_predictions.png