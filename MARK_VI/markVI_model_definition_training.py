...
import numpy as np
# Load the .npy file
data = np.load("/home/bruno/ESCI/TFG/parametric_UMAP_code/MARK_V/HIPPIE_embeddings/embeddings_1.npy") 
...
df_result.to_csv("/home/bruno/ESCI/TFG/parametric_UMAP_code/MARK_V/Mark_VI_training_results.csv", index = False)
...
output_path = "/home/bruno/ESCI/TFG/parametric_UMAP_code/MARK_VI/Mark_VI_model.onnx"
