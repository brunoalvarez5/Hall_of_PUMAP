...
with open("/home/bruno/ESCI/TFG/parametric_UMAP_code/MARK_III/AAAAAAAAAAAAAtraining_set_cortex_embeddings.csv", "w", newline="") as f:    
    writer = csv.writer(f)
...
with open("/home/bruno/ESCI/TFG/parametric_UMAP_code/MARK_III/AAAAAAAAAAAAAAAtest_set_cortex+m1_embeddings.csv", "w", newline="") as f:    
